...
#Kawale dataset
 ...
 number_of_incomplete_addresses = id_data_table_qech %>% filter(complete_address =="Incomplete") %>% nrow()
 address_completeness_proportion = number_of_incomplete_addresses/total_number_of_patients*100
 ...
 number_of_incomplete_phone_numbers = id_data_table_qech %>% filter(phone_number =="Incomplete") %>% nrow()
 phone_number_proportion = number_of_incomplete_phone_numbers/total_number_of_patients*100
 ...
 number_of_incomplete_weight_observations = bmi_data_table_qech %>% filter(weight == "NULL") %>% nrow()
 proportion_incomplete_weight_documentation = number_of_incomplete_weight_observations/total_number_of_patient_visits * 100
 proportion_incomplete_weight_documentation
 ...
 number_of_complete_viral_loads = viral_load_data_table_lh %>% filter(patient_VL_results != "") %>% nrow()
 
 proportion_of_complete_vl_lh = number_of_complete_viral_loads/total_number_of_patients 
