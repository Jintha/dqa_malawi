...
setwd("~/Box Sync/quantitative_data/")
...
setwd("~/Dropbox/dissertation_data_analysis/")
id_data_table_qech           = read.csv("patient_address/qech_address.csv", stringsAsFactors = FALSE)
drugs_data_table_qech        = read.csv("patient_drugs_taken/qech_query_drugs2.csv", stringsAsFactors = FALSE)
bmi_data_table_qech   = read.csv("patient_weight_height/qech_vitals.csv", stringsAsFactors = FALSE)
adherence_data_table_qech     = read.csv("patient_drug_adherence/mzuzu_central_adherence.csv", stringsAsFactors = FALSE)
viral_load_data_table_qech = read.csv("hiv_viral_load/qech_VL.csv", stringsAsFactors = FALSE)
...
#Qech
 ...
 number_of_patients_with_complete_adherence = adherence_data_table_qech %>% filter(complete_adeherence == "Complete")
