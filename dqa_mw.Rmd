...
variable_names_encounters = c("Current Patient Address","Patient Mobile Phone Number","Heights of Patient","Weights of Patient","Prescriptions Made","Drug Adherence", "HIV Viral Load")


encounter_numerators  = c(number_of_all_complete_addresses,number_of_all_complete_phone_numbers,total_number_of_height_visits,total_number_of_weight_visits,number_of_prescription_encounters,number_of_adherence_visits,number_of_vl_visits)

encounter_denominators = c(total_number_of_all_patients,total_number_of_all_patients,total_number_of_all_patients,total_number_of_patient_visits,total_number_of_patient_visits,total_number_of_patient_visits,total_number_of_all_patients_vl)

proportion_encounters = c(all_address_completeness_proportion,all_phone_number_proportion,proportion_height_encounters,proportion_weight_encounters, proportion_drug_encounters, proportion_adherence_encounters, proportion_of_vl_encounters) 
...
numerators_all_plausibility = c(number_of_all_plausible_addresses,
                                ...
                                vl_unique_plausibility,vl_atemporal_plausibility,
                                vl_temporal_plausibility)
...
proportions_all_plausibility = c(proportion_of_all_plausible_addresses,
                                 ...
                                 (vl_unique_plausibility/number_of_vl_visits*100),
                                 (vl_atemporal_plausibility/number_of_vl_visits*100),
                                 (vl_temporal_plausibility/number_of_vl_visits*100))
