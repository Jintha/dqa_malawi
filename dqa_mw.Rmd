...
new_viral_load_dataset_at$plausible = ifelse((new_viral_load_dataset_at$time_months >= 6 & new_viral_load_dataset_at$time_months <= 12), "Plausible","Not Plausible")
...
ggplot(cd, aes(x= address_section,  fill = address_value, group=address_value)) + 
...
labs(title = "Stakeholder Data Quality Characteristics Priorities", x = "Data Quality Characteristic Priority Question", y = "Count of Data Quality Characteristic Importance Ranking") + scale_fill_discrete(name="Importance \nRanking",
                         breaks=c("Very important", "Important", "Moderately Important","Slightly Important","Not Important"),
                         labels=c("Very important", "Important", "Neither important nor not Important","Not important","Not important at all"))
