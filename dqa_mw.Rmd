...
encounter_denominators = c(total_number_of_all_patients,total_number_of_all_patients,total_number_of_patient_visits,total_number_of_patient_visits,total_number_of_patient_visits,total_number_of_patient_visits,total_number_of_all_patients_vl)
...
# ggplot(bbvl, aes(x = health_facility_name)) +
#   geom_bar(aes(y = (..count..)/sum(..count..), fill= recorded)) +
#   geom_text(aes(y = ((..count..)/sum(..count..)),fill=recorded, label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust = -0.25) +
#   scale_y_continuous(labels = percent) +
#   labs(title = "2017 to 2018 Health Facility Patient Viral Load Observations", y = "Percent", x = "Health Facility Name") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.border = element_blank(),panel.background = element_blank(), legend.title = element_blank())
...
ggplot(bbvl, aes(health_facility_name)) + geom_bar(stat="count",aes(fill=recorded)) + geom_text(stat = 'count',aes(label =..count.., vjust = -0.2, fill=recorded)) +
  labs(title = "2017 to 2018 Health Facility Patient Viral Load Observations", y = "Count", x = "Health Facility Name") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.border = element_blank(),panel.background = element_blank(), legend.title = element_blank())
